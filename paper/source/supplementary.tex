...
learned sparsity improves over dense, communication-matched, adaptive,
and centralized prediction-selection references; \textbf{Q2}, whether the approach transfers to
...
consensus is outside the present method definition.
...
\paragraph{Validation-label flow.}
